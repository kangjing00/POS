...
public class UpdateOrderCustomerCount extends AsyncTask<String, String, String> {
    ...
    public UpdateOrderCustomerCount(Context contextpage, int order_id, int local_order_id, int customer_count){
    ...
    protected String doInBackground(String... strings) {
        ...
        String urlParameters = "&order_id=" + order_id + "&customer_count=" + customer_count;
        ...
        try{
            ...
            try{
                ...
                if (status.equals("OK")) {
                    ...
                    //order
                    update_order.setCustomer_count(jo_order.getInt("customer_count"));
                }
